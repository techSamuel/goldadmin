        ...
        <form action="{{ route('admin.announcements.update', $announcement->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="body" id="body" rows="4" required
                    class="w-full px-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500 border-gray-300">{{ old('body', $announcement->body) }}</textarea>
            </div>
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('admin.announcements.index') }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">Cancel</a>
